...
urlpatterns = [
    ...
    path('delet_chart/<int:id>',views.delet_chart,name='delet_chart'),
...
# 	path('comment/<int:id>', views.comment, name='comment'),
    ...
    path('journal_list/<int:id>',views.journal_list,name='journal_list'),
...
#----------------------------------------------------------------------------------------------------------
    ...
    path("view_manual_all",views.view_manual_all,name="view_manual_all"),
    path("view_manual_draft",views.view_manual_draft,name="view_manual_draft"),
    path("view_manual_save",views.view_manual_save,name="view_manual_save"),
    path('delet_manual/<int:id>',views.delet_manual,name='delet_manual'),
    #path('create_edit_manual_journal/<int:pk>',views.create_edit_manual_journal,name="create_edit_manual_journal"),
    
    #--------------------------------------------------------------------------------------------
    #path('manual_convert_view/<int:pk>',views.manual_convert_view,name='manual_convert_view'),
    #path('view_manual_journal_all',views.view_manual_journal_all,name="view_manual_journal_all"),
    
    #path("view_journal_all",views.view_journal_all,name="view_journal_all"),
    #path("view_journal_save",views.view_journal_save,name="view_journal_save"),
    #path("view_journal_draft",views.view_journal_draft,name="view_journal_draft"),
    #path("view_edit_chart_of_accounts_all/<int:pk>",views.view_edit_chart_of_accounts_all,name="view_edit_chart_of_accounts_all"),
    #path("view_edit_chart_of_accounts_active/<int:pk>",views.view_edit_chart_of_accounts_active,name='view_edit_chart_of_accounts_active'),
    #path("view_edit_chart_of_accounts_none/<int:pk>",views.view_edit_chart_of_accounts_none,name="view_edit_chart_of_accounts_none"),
